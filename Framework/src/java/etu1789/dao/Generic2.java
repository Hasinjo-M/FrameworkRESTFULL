...
import etu1789.dao.utility.Utility;
        ...
        try {
            ...
            while(resultat.next()){
                ...
                for (Field field : fields) {
                    g.getClass().getMethod("set" + Utility.capitalword(field.getName()), field.getType()).invoke(g, resultat.getObject(annotation.get(i)));
                    i++;
                }
                results.add(g);
                i=0;
